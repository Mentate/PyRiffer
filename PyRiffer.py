...
if __name__ == '__main__':
    ...
    if sys.argv[1:] and '-h' not in sys.argv[1:] and '--help' not in sys.argv[1:]:
        riff = os.path.expanduser(sys.argv.pop())
        ...
        movie_start = raw_input("enter movie start time in 00:00:00 format: ")
        riff_start = raw_input("enter riff start in 00:00:00 format: ")
